...
# echo "should not be here"
  ...
  # preserve the image header. Might be updated in Nick's new git
  # have to check. Here is the simple fix.

  ${UTILITIESDIR}/ChangeImageInformation 3 ${OUTPUT}_DSxxLagrangian.nii.gz ${OUTPUT}_DSxxLagrangian.nii.gz 4 $fixImage
  ${UTILITIESDIR}/ChangeImageInformation 3 ${OUTPUT}_DSyyLagrangian.nii.gz ${OUTPUT}_DSyyLagrangian.nii.gz 4 $fixImage
  ${UTILITIESDIR}/ChangeImageInformation 3 ${OUTPUT}_DSzzLagrangian.nii.gz ${OUTPUT}_DSzzLagrangian.nii.gz 4 $fixImage
  ${UTILITIESDIR}/ChangeImageInformation 3 ${OUTPUT}_DSxyLagrangian.nii.gz ${OUTPUT}_DSxyLagrangian.nii.gz 4 $fixImage
  ${UTILITIESDIR}/ChangeImageInformation 3 ${OUTPUT}_DSxzLagrangian.nii.gz ${OUTPUT}_DSxzLagrangian.nii.gz 4 $fixImage
  ${UTILITIESDIR}/ChangeImageInformation 3 ${OUTPUT}_DSyzLagrangian.nii.gz ${OUTPUT}_DSyzLagrangian.nii.gz 4 $fixImage
